<div class="egybe">
 <div class="card">
  ...
  <label for="exampleFormControlSelect1">Címkék</label> <br>
    <select class="form-control" id="exampleFormControlSelect1" style="width: 250px; display:inline-block;" name="cimke1">
    <option value="">Válassz legalább egy cimkét:</option>
...
{
  ?>
  <input type="text" name="<?=$i?>" id="<?=$i?>" style="width:33%;margin-bottom: 3px;visibility:hidden;" readonly>
  <b name="torol<?=$i?>" id="torol<?=$i?>" style="margin-bottom: 3px;visibility:hidden;" class="btn btn-danger">X</b>
  
  <?php
}
?>
<input type="text" name="rejtett" id="rejtett" style="visibility:hidden;">
<?php
