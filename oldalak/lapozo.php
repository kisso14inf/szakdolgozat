<nav>
    <ul class="pagination">
        ...
        <li class="page-item <?=$page<=1?"disabled":""?>"><a class="page-link" href="?size=<?=$size?>&page=<?=$page - 1?>"><</a></li>
        ...
        <li class="page-item <?=$page>=$lastPage?"disabled":""?>"><a class="page-link"href="?size=<?=$size?>&page=<?=$page + 1?>">></a></li>
    </ul>
</nav>